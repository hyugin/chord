...
- **Firefox / Zen shortcuts** — when Firefox or Zen is frontmost, a few kept native shortcuts appear under that app’s section in the menubar (see `docs/browser-shortcuts.md`).
